...
- `mdsingdll` now source-links fifteen exact interpolation, transition, setup, asset-loader, and state/motion functions (5,288 text bytes) and the complete 128-byte named data owner; its remaining application code stays on retail fallback, and the configured REL remains byte-identical (`badae36c280f8f5943bedde8ead4acb09139417f`).
