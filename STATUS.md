...
| --- | ---: | ---: | ---: |
| Entire project | 13.50% | 32.87% | 331 / 920 |
| Main DOL | 48.28% | 74.87% | 296 / 396 |
| REL modules | 6.12% | 6.26% | 35 / 524 |
...
- `mdsingdll` now source-links eleven exact interpolation, transition, and player/story-setup functions (3,992 text bytes) and the complete 128-byte named data owner; its remaining application code stays on retail fallback, and the configured REL remains byte-identical (`badae36c280f8f5943bedde8ead4acb09139417f`).
