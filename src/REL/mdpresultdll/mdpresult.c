...
void fn_1_2BF0(void)
{
    HuVecF shadowPos = lbl_1_rodata_16C;
    HuVecF shadowUp = lbl_1_rodata_178;
    HuVecF shadowTarget = lbl_1_rodata_184;
...
void fn_1_2F80(s16 index)
{
    ...
    Hu3DModelRotSet(obj->mdlId[0], lbl_1_rodata_104, lbl_1_rodata_104,
        lbl_1_rodata_104);
    Hu3DModelScaleSet(obj->mdlId[0], lbl_1_rodata_250, lbl_1_rodata_250,
        lbl_1_rodata_250);
...
void fn_1_31F8(OMOBJ *obj)
{
    ...
    obj->mtnId[0] = Hu3DMotionIDGet(
        obj->mdlId[0]);
    Hu3DModelLayerSet(
        obj->mdlId[0], 3);
    Hu3DMotionShiftSet(
        obj->mdlId[0],
        obj->mtnId[0], lbl_1_rodata_104, lbl_1_rodata_104,
        HU3D_MOTATTR_LOOP);
    Hu3DModelScaleSet(
        obj->mdlId[0],
        lbl_1_rodata_258, lbl_1_rodata_258, lbl_1_rodata_258);
...
inline void fn_1_3304(OMOBJ *obj);
...
void fn_1_4EF0(OMOBJ *obj)
{
    ...
    Hu3DMotionShiftSet(obj->mdlId[0], obj->mtnId[0], lbl_1_rodata_104,
        lbl_1_rodata_104, HU3D_MOTATTR_LOOP);
    Hu3DModelShadowSet(obj->mdlId[0]);
    Hu3DModelPosSet(obj->mdlId[0], lbl_1_rodata_2CC, lbl_1_rodata_104,
        lbl_1_rodata_284);
