...
void fn_1_5904(void)
{
    ...
    if (lbl_1_bss_180 == 0) {
        espColorSet(lbl_1_bss_174[0], 0x80, 0x80, 0x80);
        espColorSet(lbl_1_bss_174[1], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[0][0], 0x80, 0x80, 0x80);
        espColorSet(lbl_1_bss_16C[0][1], 0x80, 0x80, 0x80);
        espColorSet(lbl_1_bss_16C[1][0], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[1][1], 0xFF, 0xFF, 0xFF);
    } else if (lbl_1_bss_180 == 1) {
        espColorSet(lbl_1_bss_174[0], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_174[1], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[0][0], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[0][1], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[1][0], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[1][1], 0xFF, 0xFF, 0xFF);
    } else {
        espColorSet(lbl_1_bss_174[0], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_174[1], 0x80, 0x80, 0x80);
        espColorSet(lbl_1_bss_16C[0][0], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[0][1], 0xFF, 0xFF, 0xFF);
        espColorSet(lbl_1_bss_16C[1][0], 0x80, 0x80, 0x80);
        espColorSet(lbl_1_bss_16C[1][1], 0x80, 0x80, 0x80);
    }
}
...
void fn_1_69F8(void)
{
    ...
    HuWinMesMaxSizeGet(1, &size, 0x80017);
    ...
    HuWinMesSet((s16)lbl_1_bss_114, 0x80017);
