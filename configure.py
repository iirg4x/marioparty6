...
config.libs = [
    ...
    Rel(
        ...
        objects={
            ...
            Object(NonMatching, "REL/m635dll/scene.c", extra_cflags=["-pooldata off"]),
            Object(NonMatching, "REL/m635dll/sprite_init.c", extra_cflags=["-pooldata off"]),
            Object(Matching, "REL/m635dll/sprite_hit.c", extra_cflags=["-pooldata off"]),
            Object(NonMatching, "REL/m635dll/sprites.c", extra_cflags=["-pooldata off"]),
            Object(Matching, "REL/m635dll/sprite_state.c", extra_cflags=["-pooldata off"]),
            Object(NonMatching, "REL/m635dll/players.c", extra_cflags=["-pooldata off"]),
            Object(NonMatching, "REL/m635dll/motion.c", extra_cflags=["-pooldata off"]),
            Object(Matching, "REL/m635dll/position.c", extra_cflags=["-pooldata off"]),
            Object(Matching, "REL/m635dll/player_state.c", extra_cflags=["-pooldata off"]),
            Object(NonMatching, "REL/m635dll/moving.c", extra_cflags=["-pooldata off"]),
            Object(NonMatching, "REL/m635dll/models.c", extra_cflags=["-pooldata off"]),
            Object(Matching, "REL/m635dll/model_visibility.c", extra_cflags=["-pooldata off"]),
            Object(
                Matching,
